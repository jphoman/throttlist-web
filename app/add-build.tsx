...
const TYPE_CONFIG: Record<string, FieldConfig> = {
  ...
  cameras: {
    ...
    yearLabel: 'YEAR',
    makeLabel: 'BRAND',
    makePlaceholder: 'e.g. Sony, Canon, Fujifilm, Nikon',
    modelLabel: 'BODY / SYSTEM',
    modelPlaceholder: 'e.g. A7 IV, R5, X-T5, Z8',
    nicknameLabel: 'RIG NAME',
    nicknamePlaceholder: 'e.g. The Run & Gun, Studio Kit',
    popularBuilds: ['Sony A7 IV', 'Canon EOS R5', 'Fujifilm X-T5', 'Nikon Z8'],
  },
  guitars: {
    showYear: true,
    yearLabel: 'YEAR',
