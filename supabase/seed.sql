...
BEGIN
  ...
  INSERT INTO public.parts (id, build_id, name, category, type, source_url, notes, is_current, created_at) VALUES
    ...
    ('d0000002-0000-0000-0000-000000000002'::uuid, bid_crema, 'Motogadget M-Blaze Disc Turn Signals','Electrical','linkable', 'https://motogadget.com',     'Bar-end flush mount',          true, '2024-01-22'),
    ('d0000003-0000-0000-0000-000000000003'::uuid, bid_crema, 'Tarozzi Clipon Handlebars',         'Controls',   'linkable',  'https://tarozzi.it',         '50mm drop, 22mm clamp',        true, '2024-02-01'),
    ('d0000004-0000-0000-0000-000000000004'::uuid, bid_crema, 'Brat Style One-Piece Seat',         'Frame & Body','reference',null,                         'Custom leather by Brat Style', true, '2024-02-10'),
    ('d0000005-0000-0000-0000-000000000005'::uuid, bid_crema, 'Rizoma Fluid Reservoir Covers',     'Frame & Body','linkable', 'https://rizoma.com',         'Anodized black aluminium',     true, '2024-02-15'),
    ...
    ('d0000012-0000-0000-0000-000000000012'::uuid, bid_scarlett, 'Hepco & Becker Rear Carrier',     'Frame & Body','linkable', 'https://hepco-becker.de',    'Black powder coat',            true, '2024-06-10'),
    ('d0000013-0000-0000-0000-000000000013'::uuid, bid_scarlett, 'Rizoma Handlebar Grips',          'Controls',   'linkable',  'https://rizoma.com',         'Open end, black aluminium',    true, '2024-06-12'),
    ('d0000014-0000-0000-0000-000000000014'::uuid, bid_scarlett, 'Touratech Skid Plate',            'Frame & Body','linkable', 'https://touratech.com',      'Aluminium 3mm',                true, '2024-06-20'),
    ...
    ('d0000022-0000-0000-0000-000000000022'::uuid, bid_desert, 'Wunderlich Bar Riser Kit',         'Controls',   'linkable',  'https://wunderlich.de',      '25mm rise, 20mm forward',      true, '2024-02-08'),
    ('d0000023-0000-0000-0000-000000000023'::uuid, bid_desert, 'Motogadget Motoscope Mini',        'Electrical', 'linkable',  'https://motogadget.com',     'Digital, smoked glass',        true, '2024-02-15'),
    ('d0000024-0000-0000-0000-000000000024'::uuid, bid_desert, 'SW-Motech Crashbars',              'Frame & Body','linkable', 'https://sw-motech.com',      'Stainless steel engine guard',  true, '2024-02-20'),
    ('d0000025-0000-0000-0000-000000000025'::uuid, bid_desert, 'Touratech Zega Pro Panniers',      'Frame & Body','linkable', 'https://touratech.com',      '38L per side, anodised',       true, '2024-03-01'),

    -- The Black Tank (1977 Honda CB750) ─ moto_feelz
    ('d0000031-0000-0000-0000-000000000031'::uuid, bid_black, 'Clubman Clip-On Handlebars',        'Controls',   'linkable',  'https://cognimoto.com',      'Chrome 7/8" for CB750',        true, '2024-02-12'),
    ...
    ('d0000034-0000-0000-0000-000000000034'::uuid, bid_black, 'Dunlop TT100 GP Tires',             'Wheels & Tires','linkable','https://dunlopmotorcycle.com','Classic tread pattern, 18"',  true, '2024-02-20'),
    ('d0000035-0000-0000-0000-000000000035'::uuid, bid_black, 'Custom Bates-Style Headlight',      'Electrical', 'reference', null,                         'Aluminium shell, LED insert',  true, '2024-02-25'),
    ...
    ('d0000042-0000-0000-0000-000000000042'::uuid, bid_retro, 'Pyramid Belly Pan',                 'Frame & Body','linkable', 'https://pyramidplastics.co.uk','Gloss black ABS',            true, '2024-03-08'),
    ('d0000043-0000-0000-0000-000000000043'::uuid, bid_retro, 'Continental TKC80 Adventure Tires', 'Wheels & Tires','linkable','https://continental-tires.com','19" front / 17" rear',       true, '2024-03-12'),
    ('d0000044-0000-0000-0000-000000000044'::uuid, bid_retro, 'Overland Bespoke Seat',             'Frame & Body','reference',null,                         'Distressed brown leather',     true, '2024-03-15'),
    ...
    ('d0000052-0000-0000-0000-000000000052'::uuid, bid_anniv, 'Rizoma Stealth Bar End Mirrors',    'Controls',   'linkable',  'https://rizoma.com',         'CNC aluminium, anodized',      true, '2024-03-20'),
    ('d0000053-0000-0000-0000-000000000053'::uuid, bid_anniv, 'Rizoma Rider Footpeg Kit',          'Controls',   'linkable',  'https://rizoma.com',         'Billet aluminium, black',      true, '2024-03-22'),
    ('d0000054-0000-0000-0000-000000000054'::uuid, bid_anniv, 'Motogadget M-Unit Blue',            'Electrical', 'linkable',  'https://motogadget.com',     'Smart bike controller',        true, '2024-03-25'),
    ('d0000055-0000-0000-0000-000000000055'::uuid, bid_anniv, 'GIVI Windshield D2145ST',           'Front End',  'linkable',  'https://givi.it',            'Smoked 310mm, quick release',  true, '2024-03-28'),
    ...
    ('d0000063-0000-0000-0000-000000000063'::uuid, bid_coldbrew, 'Indian Motorcycle Carbon Tank Shrouds','Frame & Body','reference',null,                    'OEM factory carbon fibre',     true, '2024-04-18'),
    ('d0000064-0000-0000-0000-000000000064'::uuid, bid_coldbrew, 'Brembo M50 Monobloc Calipers',   'Front End',  'linkable',  'https://brembo.com',         '4-piston radial mount',        true, '2024-04-20'),
    ...
    ('d0000072-0000-0000-0000-000000000072'::uuid, bid_croc, 'Rizoma Bar End Mirrors',             'Controls',   'linkable',  'https://rizoma.com',         'Spy R model, black',           true, '2024-03-24'),
    ('d0000073-0000-0000-0000-000000000073'::uuid, bid_croc, 'SW-Motech Crash Bars',               'Frame & Body','linkable', 'https://sw-motech.com',      'Stainless, black powder coat',  true, '2024-03-26'),
    ('d0000074-0000-0000-0000-000000000074'::uuid, bid_croc, 'Ducati Performance Comfort Seat',    'Frame & Body','reference',null,                         'Low profile, 790mm height',    true, '2024-03-28'),
    ('d0000075-0000-0000-0000-000000000075'::uuid, bid_croc, 'Pirelli Scorpion Trail II Tires',    'Wheels & Tires','linkable','https://pirelli.com',        '120/70-19 front, 180/55-17 rear', true, '2024-04-01'),
    ...
    ('d0000082-0000-0000-0000-000000000082'::uuid, bid_bonnie, 'Triumph Accessories Rack & Panniers','Frame & Body','linkable','https://triumphmotorcycles.com','OEM expedition luggage set', true, '2024-04-05'),
    ('d0000083-0000-0000-0000-000000000083'::uuid, bid_bonnie, 'Skidmarx Classic Screen',          'Front End',  'linkable',  'https://skidmarx.co.uk',     'Dark tint, 250mm height',      true, '2024-04-08'),
    ('d0000084-0000-0000-0000-000000000084'::uuid, bid_bonnie, 'Barkbusters Storm Handguards',     'Controls',   'reference', null,                         'Black aluminium backbone',     true, '2024-04-10'),
    ('d0000085-0000-0000-0000-000000000085'::uuid, bid_bonnie, 'Motone Customs Gauge Surround',    'Electrical', 'linkable',  'https://motonecustoms.com',  'Aluminium, brushed finish',    true, '2024-04-12')
